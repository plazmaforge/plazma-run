...
%CC% %LDFLAGS% getopt.o common.o memlib.o iolib.o run_mdlib.o sha1.o run_sha1.o -o run-sha1.exe
...
%CC% %LDFLAGS% getopt.o iolib.o base16.o run_edlib.o run_base16.o -o run-base16.exe
%CC% %LDFLAGS% getopt.o iolib.o base32.o run_edlib.o run_base32.o -o run-base32.exe
%CC% %LDFLAGS% getopt.o iolib.o base58.o run_edlib.o run_base58.o -o run-base58.exe
%CC% %LDFLAGS% getopt.o iolib.o base64.o run_edlib.o run_base64.o -o run-base64.exe
...
%CC% %LDFLAGS% getopt.o run_hex2oct.o -o run-hex2oct.exe
%CC% %LDFLAGS% getopt.o run_hex2bin.o -o run-hex2bin.exe

%CC% %LDFLAGS% getopt.o run_dec2hex.o -o run-dec2hex.exe
%CC% %LDFLAGS% getopt.o run_dec2oct.o -o run-dec2oct.exe
%CC% %LDFLAGS% getopt.o run_dec2bin.o -o run-dec2bin.exe
...
%CC% %LDFLAGS% getopt.o run_dconv.o -o run-dconv.exe
...
%CC% %LDFLAGS% getopt.o iodef.o iolib.o unimap.o utf8lib.o encdef.o enclib.o run_txt2pdf.o -o run-txt2pdf.exe
...
%CC% %LDFLAGS% memlib.o array.o list.o map.o test_data.o -o test-data.exe
