...
%CC% %LDFLAGS% getopt.o strlib.o wstrlib.o pathlib.o wclib.o fslib.o fmtlib.o run_ls.o -o run-ls.exe
...
%CC% %LDFLAGS% common.o debug.o iolib.o strlib.o socketlib.o netlib.o run_get.o -o run-get.exe %LIBS%
