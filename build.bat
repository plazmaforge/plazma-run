...
%CC% %LDFLAGS% getopt.o strlib.o wstrlib.o pathlib.o wclib.o fslib.o iodef.o fmtlib.o run_ls.o -o run-ls.exe
...
%CC% %LDFLAGS% getopt.o iodef.o iolib.o run_ssl_dump.o -o run-ssl-dump.exe
